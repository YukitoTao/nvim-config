...
-- keymap('n', 'gD', '<cmd>tab split | lua vim.lsp.buf.declaration()<CR>', lsp_options)
keymap('n', 'gD', '<cmd>tab split | lua vim.lsp.buf.definition()<CR>', lsp_options)keymap('n', 'gd', '<cmd>lua vim.lsp.buf.definition()<CR>', lsp_options)
...
keymap('n', 'gs', '<cmd>lua vim.lsp.buf.signature_help()<CR>', lsp_options)
keymap('n', 'gl', '<cmd>lua vim.diagnostic.open_float()<cr>', lsp_options)
